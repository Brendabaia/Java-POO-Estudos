...
A organização do código segue a evolução lógica dos conceitos:

1.  **Classes e Atributos:** Definição da estrutura e estado do objeto.
2.  **Métodos e Comportamentos:** Lógica interna e interação entre diferentes objetos.
3.  **Construtores:** Garantindo a inicialização segura e consistente dos dados.
4.  **Interfaces e Contratos:** Definição de moldes genéricos para garantir flexibilidade.
5.  **Composição vs Herança:** Estudos sobre a melhor forma de estender funcionalidades sem criar acoplamento desnecessário.
